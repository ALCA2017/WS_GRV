...
public class MallaCurricularController {
    ...
    @RequestMapping(value = "/areas_academicas", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/unidades_didacticas", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/anios_academicos", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/temas_unidades", method = RequestMethod.GET, produces = "application/json")
